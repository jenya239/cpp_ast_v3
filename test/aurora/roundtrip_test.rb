...
class AuroraRoundtripTest < Minitest::Test
  def test_simple_function
    ...
    # 1. Parse Aurora
    ast = Aurora.parse(aurora_code)
    assert_instance_of Aurora::AST::Program, ast
    ...
    assert_instance_of Aurora::CoreIR::Module, core_ir
    assert_equal 1, core_ir.items.size
    
    func_ir = core_ir.items.first
    assert_instance_of Aurora::CoreIR::Func, func_ir
