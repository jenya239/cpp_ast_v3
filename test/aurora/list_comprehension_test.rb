...
class AuroraListComprehensionTest < Minitest::Test
  def test_parse_and_transform_single_generator
    ...
    assert_instance_of Aurora::AST::ListComprehension, func.body

    core = Aurora.transform_to_core(ast)
    core_func = core.items.first

    assert_instance_of Aurora::CoreIR::ListCompExpr, core_func.body
