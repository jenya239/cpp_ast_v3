...
require_relative "../../lib/aurora/backend/runtime_policy"
...
class RuntimePolicyTest < Minitest::Test
  ...
  def test_optimized_policy
    policy = Aurora::Backend::RuntimePolicy.optimized
  ...
  def test_conservative_policy
    policy = Aurora::Backend::RuntimePolicy.conservative
  ...
  def test_block_strategies_constant
    strategies = Aurora::Backend::RuntimePolicy::BLOCK_STRATEGIES
  ...
  def test_if_strategies_constant
    strategies = Aurora::Backend::RuntimePolicy::IF_STRATEGIES
  ...
  def test_match_strategies_constant
    strategies = Aurora::Backend::RuntimePolicy::MATCH_STRATEGIES
