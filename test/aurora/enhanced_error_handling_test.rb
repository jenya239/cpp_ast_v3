...
require_relative "../../lib/aurora/error_handling/enhanced_errors"
require_relative "../../lib/aurora/parser/error_recovery_parser"
...
class EnhancedErrorHandlingTest < Minitest::Test
  def test_syntax_error_with_suggestion
    ...
    error = Aurora::AuroraSyntaxError.new(
  ...
  def test_multiple_errors_recovery
    ...
    begin
      ...
      assert e.errors.any? { |err| err.is_a?(Aurora::AuroraSyntaxError) }, "Should have syntax errors"
    end
  end
  ...
  def test_type_error_suggestions
    ...
    begin
      ...
      error = Aurora::AuroraTypeError.new(
  ...
  def test_scope_error_suggestions
    ...
    error = Aurora::AuroraScopeError.new(
  ...
  def test_import_error_suggestions
    error = Aurora::AuroraImportError.new(
