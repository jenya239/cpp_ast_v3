...
class LoweringStrategyIntegrationTest < Minitest::Test
  ...
  def test_policy_configuration_affects_lowering
    ...
    conservative = Aurora::Backend::RuntimePolicy.conservative
    optimized = Aurora::Backend::RuntimePolicy.optimized
    ...
    gcc_opt = Aurora::Backend::RuntimePolicy.gcc_optimized
