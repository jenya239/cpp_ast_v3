...
### 2. Expression Rules (11/15) - IN PROGRESS
...
**СЕЙЧАС:** Переписывание оставшихся expression rules (4/15 осталось)

**ПРОГРЕСС:** 11/15 completed (73%)

**СЛЕДУЮЩЕЕ:** BlockRule (средняя с RuntimePolicy), потом сложные (CallRule, MatchRule, ListCompRule)
