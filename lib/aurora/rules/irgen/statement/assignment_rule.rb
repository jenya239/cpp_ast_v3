      ...
      module Statement
        ...
        class AssignmentRule < BaseRule
          ...
          def apply(node, context = {})
            ...
            target_ir = Aurora::CoreIR::Builder.var(target_name, existing_type)
            [Aurora::CoreIR::Builder.assignment_stmt(target_ir, value_ir)]
          end
        end
      end
    end
