...
module Aurora
  module Analysis
    # LowerToMidPass - transforms High IR (CoreIR) to Mid IR
    #
    # Key transformations:
    ...
    class LowerToMidPass < BasePass
      ...
      def lower_if_expr(if_expr)
        ...
        if if_expr.else_branch
          ...
          else_value = MidIR::Literal.new(value: nil, type: CoreIR::UnitType.new)
        end
      ...
      def lower_block_expr(block_expr)
        ...
        last_value || MidIR::Literal.new(value: nil, type: CoreIR::UnitType.new)
      end
